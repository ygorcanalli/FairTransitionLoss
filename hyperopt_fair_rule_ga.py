...
def adult_dataset_reader():
    ...
    return dataset_train, dataset_val, dataset_test, unprivileged_groups, privileged_groups, sens_attr

def fair_mlp_initializer(sens_attr, solution=None):
...
def evolve_model(dataset_reader, model_initializer, fitness_rule):
    ...
    def fitness_function(solution, solution_idx):
        ...
        model = model_initializer(sens_attr, solution)
    ...
    if fitness_rule is not None:
        ...
        # eval on test set
        model = model_initializer(sens_attr, best_solution)
    else:
