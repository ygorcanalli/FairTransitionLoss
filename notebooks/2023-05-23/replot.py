...
get_table_with_relative_difference(results, numerical_columns)[latex_columns]\
    .rename(columns=metric_names).set_index('method').T.to_latex('parity_tb.txt')
...
get_table_with_relative_difference(results, numerical_columns)[latex_columns]\
    .rename(columns=metric_names).set_index('method').T.to_latex('odds_tb.txt')
...
get_table_with_relative_difference(results, numerical_columns)[latex_columns]\
    .rename(columns=metric_names).set_index('method').T.to_latex('opp_tb.txt')
